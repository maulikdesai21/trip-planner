...
export type IconName =
  | 'plus' | 'back' | 'chevron' | 'edit' | 'trash' | 'calendar'
  | 'pin' | 'dots' | 'search' | 'plane' | 'image' | 'check' | 'x' | 'sparkle';
...
export default function Icon({ name, size = 20, stroke = 'currentColor', sw = 1.9, fill = 'none', style, className }: IconProps) {
  return (
